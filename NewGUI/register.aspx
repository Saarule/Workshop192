<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="NewGUI.register" %>
...
<head runat="server">
  ...
  <script src="App_Code/ButtonsHandler.cs"></script>
</head>
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav-shop">
              <li class="nav-item"><a class="button button-header" href="myCart.aspx">Buy Now</a></li>
            </ul>
          </div>
        </div>
      </nav>
				...
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
                        ...
                        //-->
                            ...
                            <asp:TextBox id="ConfirmPasswordTextBox" runat="server" placeholder="Confirm Password" class="form-control" type="text"></asp:TextBox>
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
                                ...
                                <asp:Button ID="SendButton1" runat="server" class="button button-register w-100" Text="Sign Up" OnClick="RegisterButton1_Click" />
							</div>
						<!-- </form> -->
					</div>
				</div>
